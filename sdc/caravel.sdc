...
set_case_analysis 1 [get_pins {mprj/u_riscv_top.i_core_top_1/cfg_ccska[1]}]
...
set_case_analysis 1 [get_pins {mprj/u_riscv_top.i_core_top_0/cfg_ccska[1]}]
set_case_analysis 1 [get_pins {mprj/u_riscv_top.i_core_top_0/cfg_ccska[0]}]
