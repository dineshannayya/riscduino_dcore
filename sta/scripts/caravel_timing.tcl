    ...
    read_spef -path mprj/u_riscv_top.u_connect          $::env(USER_ROOT)/signoff/ycr2_iconnect/openlane-signoff/spef/ycr2_iconnect.nom.spef
    ...
    read_spef -path mprj/u_riscv_top.i_core_top_1       $::env(USER_ROOT)/signoff/ycr_core_top/openlane-signoff/spef/ycr_core_top.nom.spef
