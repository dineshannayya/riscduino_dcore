...
#Clock Gating Black Box - Dinesh A
if { [info exists ::env(SYNTH_ENB_CG)] } {
    read_verilog -sv -lib $::env(SYNTH_CG_BBOX)
}
...
#Enable clock gating - Dinesh A
    write_verilog -noattr -noexpr -nohex -nodec -defparam $::env(synthesis_tmpfiles)/pre_cg_map.v
if { [info exists ::env(SYNTH_ENB_CG)] } {
     reg_clock_gating -map $::env(SYNTH_CG_MAP)
}
    write_verilog -noattr -noexpr -nohex -nodec -defparam $::env(synthesis_tmpfiles)/post_cg_map.v
