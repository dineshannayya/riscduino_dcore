...
set ::env(SYNTH_CG_MAP)  $::env(OPENLANE_ROOT)/plugin/yosys/Lighter/sky130_ff_map.v
set ::env(SYNTH_CG_BBOX) $::env(OPENLANE_ROOT)/plugin/yosys/Lighter/sky130_clkg_blackbox.v
